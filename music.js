...
function (artist.push(title))

// var currentSong = [artist]
// var arrayArtist = [artist.song]
...
var vanHalen = new Artist("Van Halen");//artist.name
var jump = new Song("Jump!", vanHalen);//artist.song
