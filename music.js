// Define the Artist constructor function here, with a 'name' property that can be
...
// Define the Song constructor function here,
//with 'title' and 'artist' properties that can be set at instantiation,
// and a 'playCount' property that is an empty array to start
function Song(title,artist) {
  this.title = title;
  this.artist = artist;
  this.playCount = [];
  // When a new song is instantiated, you'll want to add that
  //song to its artist's 'songs' array.
