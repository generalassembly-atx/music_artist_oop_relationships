...
// Function example w 'this'
//
// function expression
//
// function Animal(name, species, call){
//   this.name = name;
...
//     console.log(
//       ["Hi! i'm ", this.name, ' the ', this.species].join('')
//       );
//
//   };
// };
//
// var rabbit = new Animal('Roger', 'Rabbit','shirp grunnnnnnt');
//
// rabbit.explainYourself();
